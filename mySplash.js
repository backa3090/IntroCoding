class Splash {
 ...
 constructor() {
  ...
  this.info = createDiv("Let's JAM! Tell us, The Trifecta (a new cool band), what to play!! <p> AND have fun ;P <p> <a href=https://editor.p5js.org/Aback4/sketches/qBOpYHmpk>view code</a>");
