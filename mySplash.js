class Splash {
 ...
 constructor() {
  ...
  this.title = createDiv("Trifecta Jam Sess");
  ...
  this.name = createDiv("Alex Back");
  this.name.position(this.splashBorder+20, this.splashBorder+60);
  
  this.info = createDiv("Let's JAM! Tell us, The Trifecta (a new cool band), what to play!! <p> AND have fun ;P <p> <a href=https://editor.p5js.org/Aback4/sketches/oKlmCZHv5>view code</a>");
